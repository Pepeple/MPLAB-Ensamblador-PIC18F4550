...
#define usb_bus_sense       PORTAbits.RA2
#else
#define usb_bus_sense       1
#endif

#define tris_self_power     TRISAbits.TRISA1    // Input

#if defined(USE_SELF_POWER_SENSE_IO)
#define self_power          PORTAbits.RA1
#else
#define self_power          1
#endif
...
// Esta linea se agrege para correr mi apliacion con el 18F2550
#define mInitAllLEDs()      LATC &= 0xF0; TRISC &= 0xF0;LATA &= 0x00;TRISA &= 0x00 ;
